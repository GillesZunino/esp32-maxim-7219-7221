...
5. A momentary single pole, single throw switch. Connect one side of the switch to `GPIO 38` (ESP32S3) or `GPIO 17` (ESP32) and the other side to GND. On ESP32-H2-DevKitM-1, the `S1` (or `BOOT`) button can be used without external hardware.
