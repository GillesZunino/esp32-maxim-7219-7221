...
0. I intialize the ESP temperature sensor via `temperature_sensor_install()` and `temperature_sensor_enable()`,
...
8. Display the current, minimum and maximum temperatur with `led_driver_max7219_set_digits()`,
